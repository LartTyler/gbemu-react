...
import {Register8FromValue16Address} from './Register8FromValue16Address';
...
export const loadInstructions = [
	...
	// LD r8, (n16)
	new Register8FromValue16Address(0xFA, 'a'),
	...
	// LD (n16), r8
	new Value16AddressFromRegister8(0xEA, 'a'),
	...
	// LDHL SP, s8
	new Register16FromSPAndSignedValue8(0xF8, 'hl'),
];
